package com.intrbiz.balsa.doxia;
...
public class BalsaSink implements Sink
{
    private boolean inTitle = false;

    private StringBuilder title = new StringBuilder();
    
    private StringBuilder verb = new StringBuilder();
    ...
    public void body(SinkEventAttributes attributes)
    {
        ...
        if (title != null && title.length() > 0) this.root.addAttribute("title", new ValueExpression(new StringLiteral(title, false)));
    ...
    {
        Component pre = pop("pre");
        pre.setText(new ValueExpression(new StringLiteral(this.verb.toString().trim(), false)));
        this.verb = new StringBuilder();
        this.verbatim = false;
    }
